...
# Esquema del JSON de especificaciones del vehículo
vehicle_json_schema = {
    "title": "vehicle_specifications",
    "description": "Technical specifications of a vehicle.",
    "type": "object",
    "properties": {
        "brand": {"type": "string", "description": "The brand of the vehicle."},
        "model": {"type": "string", "description": "The model of the vehicle."},
        "version": {"type": "string", "description": "The version or complete version of the vehicle (if applicable).",
                    "default": None},
        "year": {"type": "integer", "description": "The year of manufacturing of the vehicle."},
        "body_type": {
            "type": "string",
            "description": "The type of the vehicle's body.",
            "enum": [
                "Turismo familiar", "Turismo", "Todoterreno", "Vehículo comercial", "Descapotable",
                "Pick Up", "Monovolumen", "Coupé", "Monovolumen_parecido_a_vehículo_comercial"
            ]
        },
        "doors": {"type": "integer", "description": "The number of doors the vehicle has.", "default": None},
        "status": {"type": "string", "description": "The status of the vehicle (e.g., for sale, discontinued).",
                   "default": None},
        "length": {"type": "integer", "description": "The length of the vehicle in millimeters (mm).", "default": None},
        "seats": {"type": "integer", "description": "The number of seats in the vehicle.", "default": None},
        "price": {"type": "number", "description": "The price of the vehicle in euros (€).", "default": None},
        "technology": {
            "type": "string",
            "description": "The technology of the vehicle.",
            "enum": ["HEV", "MHEV", "PHEV", "EV", "EREV", "Combustion"]
        },
        "transmission": {"type": "string", "description": "The type of transmission (e.g., manual, automatic).",
                         "default": None},
        ...
        "fuel_type": {
            ...
            "enum": ["gasoleo", "gasolina", "electricidad", "etanol", "gas natural", "glp", "hidrogeno"]
        },
        "electric_range": {"type": "integer",
        ...
        "battery_capacity": {"type": "number",
                             ...
                             "default": None},
        "electric_consumption": {"type": "number",
        ...
        "charging_time": {"type": "number",
                          ...
                          "default": None},
        "duplicate_date": {"type": "string",
                           "description": "A date to distinguish between duplicates in the format MMM-YY (e.g., Sep-24)."},
        "max_power": {
            "type": "object",
            "properties": {
                "cv": {"type": "integer", "description": "Horsepower of the vehicle.", "default": None},
                "kw": {"type": "integer", "description": "Kilowatts of the vehicle.", "default": None}
            },
            "default": None
        },
        "acceleration": {"type": "number",
                         ...
                         "default": None},
        "displacement": {"type": "integer", "description": "The engine displacement in cubic centimeters (cc).",
                         "default": None},
        "environmental_label": {"type": "string", "description": "The vehicle's environmental label (e.g., Euro 6).",
                                "default": None},
        "co2_emissions": {"type": "number", "description": "The CO2 emissions in grams per kilometer (gCO2/km).",
                          "default": None},
        ...
        "max_speed": {"type": "number",
                      ...
                      "default": None},
        "maintenance_costs": {"type": "number",
                              "description": "The monthly maintenance costs in euros per month (€/month).",
                              "default": None},
        "euro_ncap_rating": {"type": "integer", "description": "The EuroNCAP rating in stars.", "default": None},
        "sources": {"type": "string", "description": "List of web pages from which data were extracted",
                    "default": None}
    }
}

# Crear LLMs con salida estructurada
structured_llm_openai = llm_openai.with_structured_output(vehicle_json_schema)
structured_llm_anthropic = llm_anthropic.with_structured_output(vehicle_json_schema)
...
# Función para calcular tokens en OpenAI (si necesitas coste estimado)
def calcular_coste(num_tokens):
    coste_por_token = 0.03 / 1000  # Precio Aproximado
    return num_tokens * coste_por_token


# Endpoint para extraer las especificaciones del vehículo de ambos modelos
...
async def extract_vehicle_specifications(request: VehicleRequest):
    try:
        ...
        openai_response = structured_llm_openai.invoke(prompt)
        anthropic_response = structured_llm_anthropic.invoke(prompt)


        # Imprimir y devolver las respuestas
        logging.info(f"Respuesta OpenAI: {openai_response}")
        logging.info(f"Respuesta Anthropic: {anthropic_response}")

        combined_response = {
            "openai_data": openai_response,
            "anthropic_data": anthropic_response
        }
